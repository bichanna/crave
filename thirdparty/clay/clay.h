...
/* Recipe Vault: treat this vendored header as a system header so that our
 * strict -Wall -Wextra -Wpedantic -Werror build does not flag third-party code.
 * Harmless on compilers that are not GCC/Clang. */
